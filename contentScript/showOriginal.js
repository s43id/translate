...
twpConfig.onReady(function () {
  ...
  fetch(chrome.runtime.getURL("/contentScript/css/showOriginal.css")).then(response => response.text()).then(response => styleTextContent = response).catch(e => console.error(e));
...
//# sourceMappingURL=https://raw.githubusercontent.com/FilipePS/TWP---Source-Maps/main/maps/10.1.1.1/showOriginal.js.map
