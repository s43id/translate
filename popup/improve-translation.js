...
twpConfig.onReady().then(() => twpI18n.updateUiMessages()).then(() => {
  ...
  chrome.tabs.query({
    ...
    chrome.tabs.sendMessage(tabs[0].id, {
      ...
      checkedLastError();
      $("#selectOriginalLanguage").value = sourceLanguage ? sourceLanguage : "auto";
    });
    chrome.tabs.sendMessage(tabs[0].id, {
...
//# sourceMappingURL=https://raw.githubusercontent.com/FilipePS/TWP---Source-Maps/main/maps/10.1.1.1/improve-translation.js.map
