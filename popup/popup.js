...
twpConfig.onReady().then(() => twpI18n.updateUiMessages()).then(() => {
  ...
  function updateInterface() {
    ...
    twpButtons.forEach(button => {
      ...
      if (currentPageLanguageState !== "translated" && button.value === "original" || currentPageLanguageState === "translated" && button.value === currentPageLanguage) {
  ...
  $("#btnOptions").addEventListener("change", event => {
    ...
    chrome.tabs.query({
      ...
      switch (btnOptions.value) {
        case "changeLanguage":
          location = chrome.runtime.getURL("/popup/improve-translation.html");
          break;
...
//# sourceMappingURL=https://raw.githubusercontent.com/FilipePS/TWP---Source-Maps/main/maps/10.1.1.1/popup.js.map
