...
twpConfig.onReady().then(() => twpI18n.updateUiMessages()).then(() => {
  ...
  chrome.tabs.query({
    ...
    chrome.tabs.detectLanguage(tabs[0].id, lang => lang ? originalTabLanguage = lang : void 0);
  });
  ...
  eListenTranslated.onclick = () => {
    ...
    onListenClick("translated", eListenTranslated, eTextTranslated.textContent, currentTargetLanguage);
  };
...
//# sourceMappingURL=https://raw.githubusercontent.com/FilipePS/TWP---Source-Maps/main/maps/10.1.1.1/popup-translate-text.js.map
